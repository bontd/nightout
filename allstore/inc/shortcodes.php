...
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/posts.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/social.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/products.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/products_carousel.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/products_carousel_small.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/products_categories.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/products_brands.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/products_column.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/banners.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/image_half.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/video.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/images_carousel.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/menu.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/links_list.php' );
include( trailingslashit( get_template_directory() ) . 'inc/shortcodes/links_modal.php' );
